    ...
    return (
        <section className="container  main-section py-5">
            <div className="d-flex align-items-center flex-wrap mb-5">
                <div>
                    <p className="text-danger fw-semibold subtitle d-flex align-items-center">
                        Popular Dishes <span className="red-line ms-2"></span>
                    </p>
                    <h1 className="fw-bold">Browse Our Menu</h1>
                </div>
            ...
            <div className="row justify-content-center g-4">
                {pizzas.map((pizza, index) => (
                    <div className="col-md-4" key={index}>
                        <div className="card border-1  p-3 menu-card h-100">
